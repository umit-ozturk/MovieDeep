...
from filmAdvice.movie.views import MovieView, RecommendView, get_random_movie_request, save_rate_movie, save_watch_list
...
urlpatterns = [
    ...
    path('<str:slug>/', save_watch_list, name='save_watch_list'),
